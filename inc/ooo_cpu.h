...
public:
    ...
    CACHE ITLB{"ITLB", ITLB_SET, ITLB_WAY, ITLB_SET*ITLB_WAY, ITLB_WQ_SIZE, ITLB_RQ_SIZE, ITLB_PQ_SIZE, ITLB_MSHR_SIZE},
          ...
          // pravesh: shadowSTLB
          // Parallel shadow STLB cache structure storing 4-PTE translation blocks (indexed by newVPN = VPN >> 2)
          shadowSTLB{"shadowSTLB", STLB_SET, STLB_WAY, STLB_SET*STLB_WAY, STLB_WQ_SIZE, STLB_RQ_SIZE, STLB_PQ_SIZE, STLB_MSHR_SIZE},
